...
public class FileReadWrite {
    static final String PATH ="A:\\AddressBookSystem\\src\\com\\bridgelabz\\AddressBookSystem\\contact.txt";
    ...
    public static void writeCSV(ArrayList<Contact> list, String addressBookName) throws IOException {
        ...
        for (Contact contacts : list) {
            String[] contactData = new String[]{contacts.getFirstName(), contacts.getLastName(), contacts.getAddress(), contacts.getCity(), contacts.getState(), contacts.getZipCode(), contacts.getPhoneNumber(), contacts.getEmail()};
